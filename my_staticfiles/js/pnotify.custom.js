...
var init = function(root){
  ...
  $.extend(PNotify.prototype, {
    ...
    init: function(){
      ...
      // Create our widget.
      // Stop animation, reset the removal timer when the user_type mouses over.
      this.elem = $("<div />", {
...
(function (root, factory) {
  ...
  PNotify.prototype.options.buttons = {
    // Provide a button for the user_type to manually close the notice.
    closer: true,
    // Only show the closer button on hover.
    closer_hover: true,
    // Provide a button for the user_type to manually stick the notice.
    sticker: true,
    ...
    buttons: [
      {
        text: "Ok",
        addClass: "",
        // Whether to trigger this button when the user_type hits enter in a single line prompt.
        promptTrigger: true,
...
(function (root, factory) {
  ...
  PNotify.prototype.options.mobile = {
    // Let the user_type swipe the notice away.
    swipe_dismiss: true,
